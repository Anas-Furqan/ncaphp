...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM urdu WHERE id = $id";
...
$result = $conn->query("SELECT * FROM urdu");
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/urdu/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
