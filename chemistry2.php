...
$query = $pdo->prepare("SELECT * FROM chemistry2");
$query->execute();
...
<body>
    ...
    <main class="physics-container">
        <h1>Chemistry XII Notes</h1>
        <div class="pdf-grid">
            <?php foreach ($pdfs as $pdf): ?>
                <div class="pdf-item">
                    <embed src="uploads/chemistry2/<?php echo htmlspecialchars($pdf['filename']); ?>" type="application/pdf" class="pdf-preview" />
