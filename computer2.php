...
$query = $pdo->prepare("SELECT * FROM computer_science2");
$query->execute();
...
<body>
    ...
    <main class="physics-container">
        <h1>Computer XII Notes</h1>
        <div class="pdf-grid">
            <?php foreach ($pdfs as $pdf): ?>
                <div class="pdf-item">
                    <embed src="uploads/computer2/<?php echo htmlspecialchars($pdf['filename']); ?>" type="application/pdf" class="pdf-preview" />
