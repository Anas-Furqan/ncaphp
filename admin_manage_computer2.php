...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM computer_science2 WHERE id = $id";
...
$result = $conn->query("SELECT * FROM computer_science2");
...
<head>
    ...
    <title>Manage Computer XII Notes</title>
...
<div class="admin-container">
    <div class="admin-sidebar">
        ...
        <div class="admin-main">
            <h1>Manage Computer XII Notes</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/computer2/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
