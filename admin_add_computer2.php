...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "uploads/computer2/";
    $target_file = $target_dir . basename($file);

    if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
        $sql = "INSERT INTO computer_science2 (title, description, file) VALUES ('$title', '$description', '$file')";
...
<head>
    ...
    <title>Add Computer XII Notes</title>
