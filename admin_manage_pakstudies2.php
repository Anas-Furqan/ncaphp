...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM pak_studies2 WHERE id = $id";
...
$result = $conn->query("SELECT * FROM pak_studies2");
...
<head>
    ...
    <title>Manage Pakistan Studies XII Notes</title>
...
<div class="admin-container">
    <div class="admin-sidebar">
        ...
        <div class="admin-main">
            <h1>Manage Pakistan Studies XII Notes</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/pak_studies2/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
