...
$query = $pdo->prepare("SELECT * FROM islamiat");
$query->execute();
...
<head>
    ...
    <title>Islamiat Notes | Your College Community</title>
...
<body>
    ...
    <main class="physics-container">
        <h1>Islamiat XI Notes</h1>
        <div class="pdf-grid">
            <?php foreach ($pdfs as $pdf): ?>
                <div class="pdf-item">
                    <embed src="uploads/islamiat/<?php echo htmlspecialchars($pdf['filename']); ?>" type="application/pdf" class="pdf-preview" />
