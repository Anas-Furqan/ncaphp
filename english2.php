...
$query = $pdo->prepare("SELECT * FROM english2");
$query->execute();
...
<body>
    ...
    <main class="physics-container">
        <h1>English XII Notes</h1>
        <div class="pdf-grid">
            <?php foreach ($pdfs as $pdf): ?>
                <div class="pdf-item">
                    <embed src="uploads/english2/<?php echo htmlspecialchars($pdf['filename']); ?>" type="application/pdf" class="pdf-preview" />
