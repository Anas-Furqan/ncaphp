...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM urdu2 WHERE id = $id";
...
$result = $conn->query("SELECT * FROM urdu2");
...
<head>
    ...
    <title>Manage Urdu XII Notes</title>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/urdu2/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
