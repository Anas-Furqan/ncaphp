...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM chemistry2 WHERE id = $id";
...
$result = $conn->query("SELECT * FROM chemistry2");
...
<head>
    ...
    <title>Manage Chemistry XII Notes</title>
...
<div class="admin-container">
    <div class="admin-sidebar">
        ...
        <div class="admin-main">
            <h1>Manage Chemistry XII Notes</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/chemistry2/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
