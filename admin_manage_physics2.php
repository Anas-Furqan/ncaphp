...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM physics2 WHERE id = $id";
...
$result = $conn->query("SELECT * FROM physics2");
...
<head>
    ...
    <title>Manage Physics XII Notes</title>
...
<div class="admin-container">
    <div class="admin-sidebar">
        ...
        <div class="admin-main">
            <h1>Manage Physics XII Notes</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/physics2/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
