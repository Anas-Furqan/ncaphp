...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM computer_science WHERE id = $id";
...
$result = $conn->query("SELECT * FROM computer_science");
...
<head>
    ...
    <title>Manage Computer Notes</title>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/computer/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
