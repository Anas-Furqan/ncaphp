...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "uploads/english2/";
    $target_file = $target_dir . basename($file);

    if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
        $sql = "INSERT INTO english2 (title, description, file) VALUES ('$title', '$description', '$file')";
...
<head>
    ...
    <title>Add English XII Notes</title>
