...
$result = $conn->query("SELECT * FROM maths2");
...
<head>
    ...
    <title>Manage Maths XII Notes</title>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="uploads/maths2/<?php echo $row['file']; ?>" target="_blank">View PDF</a></td>
                        <td>
