...
$query = $pdo->prepare("SELECT * FROM pak_studies2");
$query->execute();
...
<head>
    ...
    <title>Pak Studies Notes | Your College Community</title>
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="pakstudies.css">
</head>
<body>
    <!-- Header (Navbar) -->
    <header>
    ...
    <main class="physics-container">
        <h1>Pakistan Studies XII Notes</h1>
        <div class="pdf-grid">
            <?php foreach ($pdfs as $pdf): ?>
                <div class="pdf-item">
                    <embed src="uploads/pak_studies2/<?php echo htmlspecialchars($pdf['filename']); ?>" type="application/pdf" class="pdf-preview" />
